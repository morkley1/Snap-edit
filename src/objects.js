...
SpriteMorph.prototype.getColor = function () {
    return this.color;
};
...
SpriteMorph.prototype.getPenColor = function () {
    if (this.inheritsAttribute('pen color')) {
        return this.exemplar.getPenColor();
    }
    return this.color;
};
...
SpriteMorph.prototype.colorMorph = function (clr) {
    var sym = new ColorSlotMorph(clr);
    sym.isStatic = true;
    sym.fixLayout();
    return sym;
};
...
CellMorph.prototype.createContents = function () {
    ...
    if (!isSameList && !isSameTable) {
        if (this.contents instanceof Morph) {
            ...
            img = SpriteMorph.prototype.colorMorph.call(
                null,
                this.contents
            ).fullImage();
            this.contentsMorph = new Morph();
